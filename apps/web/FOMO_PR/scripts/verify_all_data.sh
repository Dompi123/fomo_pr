...
DERIVED_DATA_DIR=$(xcodebuild -scheme FOMO_PR -configuration Debug -sdk iphonesimulator -showBuildSettings | grep -m 1 "BUILT_PRODUCTS_DIR" | grep -oE "\/.*")
BUILD_DIR="${DERIVED_DATA_DIR}/FOMO_PR.app"
