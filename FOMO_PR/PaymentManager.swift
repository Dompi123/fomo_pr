...
// MARK: - PaymentManager
// This file provides a single implementation of PaymentManager that uses our FOMOSecurity types
...
public class PaymentManager {
    ...
    public init(tokenizationService: TokenizationService = FOMOSecurity.LiveTokenizationService.shared) {
